...
package body Animal is
  function Init
    ...
    Result : Creature;
  begin
    Ada.Text_IO.Put_Line("Creating " & Name);
  ...
  function Init_Access
    (Name: in String;
     Legs: in Natural)
    return Creature_Access is
    Result : Creature_Access;
  begin
    Ada.Text_IO.Put_Line("Creating access " & Name);
    Result := new Creature;
    Result.Name := Ada.Strings.Unbounded.To_Unbounded_String(Name);
    Result.Legs := Legs;
    return Result;
  ...
  function Init_Access
    return Creature_Access is
  begin
    return Init_Access("", Natural'First);
  end Init_Access;
  ...
  begin
    Ada.Text_IO.Put_Line("Killing " & Ada.Strings.Unbounded.To_String(Item.Name));
